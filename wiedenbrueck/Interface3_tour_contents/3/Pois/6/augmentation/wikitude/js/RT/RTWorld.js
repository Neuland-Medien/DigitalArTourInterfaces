...
function createRotation2Animation(drawable){
		...
		var liftingAnimation1 = new AR.PropertyAnimation(drawable, "translate.z", 0, 0, 300, {
				type: AR.CONST.EASING_CURVE_TYPE.LINEAR
			}, {
				onFinish: function () {
					var liftingAnimation2 = new AR.PropertyAnimation(drawable, "translate.z", 0, drawable.positionZ, 300, {
							type: AR.CONST.EASING_CURVE_TYPE.LINEAR
						});
					liftingAnimation2.start();
				}
